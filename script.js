// O restante do seu código para importar e exportar arquivos
document.getElementById('importBtn').addEventListener('click', function() {
    ...
    reader.onload = function(e) {
        ...
        // Extrai as colunas A e C a partir da linha 11 (índice 10)
...
function exportToXLSX(data) {
    ...
    // Nome do arquivo
    const fileName = `Romaneio_${formattedDate}.xlsx`;
